...
const styles = tv({
  base: 'group bg-slate-700 dark:bg-slate-600 border border-slate-800 dark:border-white/10 shadow-[inset_0_1px_0_0_theme(colors.gray.600)] dark:shadow-none text-white text-sm rounded-md drop-shadow-lg will-change-transform px-3 py-1',
  variants: {
    isEntering: {
