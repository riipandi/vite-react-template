export function NavBarCollapseDark() {
  return (
    <div className='flex h-full min-h-screen w-16 flex-col items-center overflow-hidden rounded-r bg-gray-900 text-gray-400'>
