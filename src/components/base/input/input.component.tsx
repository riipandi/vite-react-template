...
export const inputStyles = tv({
  base: [
    'text-foreground-neutral placeholder:text-foreground-neutral-faded/80 shadow-raised h-9 w-full rounded-sm px-3 text-sm transition-[color,box-shadow]',
    ...
    'file:text-on-background-neutral file:ring-border-neutral hover:file:bg-background-neutral-faded file:mr-3 file:h-6 file:bg-transparent',
...
export function Input({ className, variant, ...props }: InputProps) {
  ...
  return <BaseInput data-slot='input' className={cx(styles, className)} {...props} />
}
