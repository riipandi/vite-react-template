...
import {
  dndRowDragStyle,
  dataGridTableDndRowsStyles as s2
} from './data-grid-table-dnd-rows.stylex'
            ...
            <DataGridTableBodyRowCell cell={cell} key={cell.id}>
              ...
              {dropEdge && index === cells.length - 1 ? (
                ...
                >
                  ...
                  <span {...stylex.props(s2.dropIndicatorBar)} />
                </div>
              ) : null}
            </DataGridTableBodyRowCell>
          )
                    ...
                    >
                      {carriedRow
                        ...
                        .map((cell: Cell<DataGridFeatures, TData, unknown>, index: number) => (
                          ...
                          >
                            <div {...stylex.props(s2.overlayCellInner)}>
                              {flexRender(cell.column.columnDef.cell, cell.getContext())}
                            </div>
                          </td>
                        ))}
