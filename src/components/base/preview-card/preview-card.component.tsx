...
const previewCardStyles = tv({
  slots: {
    ...
    popup: [
      ...
      'bg-background-elevation-overlay ring-border-neutral shadow-overlay origin-(--transform-origin) rounded-lg ring',
    ...
    <BasePreviewCard.Portal>
      ...
      >
        <BasePreviewCard.Popup
          ...
          {...props}
        >
          <BasePreviewCard.Arrow className={cx(styles.arrow())}>
