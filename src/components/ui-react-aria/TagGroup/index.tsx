...
const colors = {
  ...
  blue: 'bg-primary-100 text-blue-700 border-blue-200 hover:border-blue-300 dark:bg-primary-400/20 dark:text-blue-300 dark:border-blue-400/10 dark:hover:border-blue-400/20',
}
...
const tagStyles = tv({
  ...
  variants: {
    ...
    isSelected: {
      true: 'bg-primary-600 text-white border-transparent forced-colors:bg-[Highlight] forced-colors:text-[HighlightText] forced-color-adjust-none',
    },
    isDisabled: {
